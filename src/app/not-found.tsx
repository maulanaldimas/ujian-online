  ...
  return (
    <PageBackground className="flex items-center justify-center p-5">
      <Card className="w-full max-w-md p-8 text-center">
        ...
        <p className="font-display text-5xl font-bold text-[#10192E] mb-2">404</p>
        <h1 className="font-display text-lg font-bold text-[#10192E] mb-2">Halaman Tidak Ditemukan</h1>
